...
- **Mobile (手机)**: Seamless on mid-range chips (Snapdragon 6 / Dimensity 7 Series).
- **Efficiency**: 32,768 Context Length with FlashAttention optimization.
- **Privacy**: 100% Local. Zero data leakage. No cloud dependencies. (数据零外发，纯本地隐私)
...
**Developer**: JOVI LIEW (WesternOverlord / 西楚霸王)
